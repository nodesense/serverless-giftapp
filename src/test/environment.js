...
if ( ! ('AWS_DEFAULT_REGION_TEST' in process.env)) {
    console.error("Could not find TEST ACCOUNT FOR TEST, set AWS_DEFAULT_REGION_TEST Env variable")
    process.exit(-1);
}
...
process.env.AWS_DEFAULT_REGION = process.env.AWS_DEFAULT_REGION_TEST
